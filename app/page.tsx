  ...
  return <>
    <section className="hero hero-photo">
      ...
      <div className="container hero-content"><Reveal className="hero-copy">
        ...
        <div className="actions"><Link className="button orange" href="#servis-talebi">Servis Talebi Oluştur</Link><Link className="button hero-outline" href={COMPANY.phoneHref}>Hemen Ara</Link></div>
    ...
    <section className="section"><div className="container"><Reveal><div className="section-heading"><p className="eyebrow">Kolay erişim</p><h2>İhtiyacınız olan bilgiye hızlıca ulaşın</h2></div></Reveal><div className="quick-grid">
      ...
      <Link href="#servis-talebi" className="quick-card"><span>02</span><h3>Servis Talebi</h3><p>Cihaz ve arıza detaylarını ileterek süreç başlatın.</p><b>Talep oluştur →</b></Link>
